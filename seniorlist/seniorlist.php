				...
				<div class="col-lg-12">
					<div class="card float-left m-3" style="width: 1000px;height: 400px;">
						<div class="card-header">
							<h4 style="text-align: center;">Information of seniors</h4>
						</div>
						<div class="card-body">
							...
							<?php while($blogs=mysqli_fetch_assoc($info)) { ?>
							<tr>
								<td>1</td>
								<td><?php echo $blogs['username'] ?></td>
								<td><?php echo $blogs['contact'] ?></td>
								<td><?php echo $blogs['email'] ?></td>
								<td><?php echo $blogs['facebookid'] ?></td>
								<td><?php echo $blogs['linkdinid'] ?></td>
								<td><?php echo $blogs['session'] ?></td>
							</tr>
							<?php } ?>
						</table>
						</div>
