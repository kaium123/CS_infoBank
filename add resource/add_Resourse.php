<?php
	...
	if(isset($_POST['btn'])){
		...
		$result=$blog->add_resource($result);
	}
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="dropdown">
							...
							<div class="dropdown-menu bg-grey " style="background-color: grey;">
								<a href="../serviceeducation/serviceeducation.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-1</a>
								<a href="../service.healthcare/service.healthcare.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-2</a>
								<a href="../service.streetlighting/service.streetlighting.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-3</a>
								<a href="../service.certificateissue/service.certificateissue.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-4</a>
								<a href="../service.tax/service.tax.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-5</a>
								<a href="../service.tax/service.tax.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-6</a>
								<a href="../service.tax/service.tax.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-7</a>
								<a href="../service.tax/service.tax.php?id=<?php echo $id ?>" class="dropdown-item text-warning">SEMESTER-8</a>
							</div>
							
						</li>
						<li >
							<a href="" class=" nav-link " style="font-size: 20px;">CONTACT SENIORS</a>
						</li>
			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-header">
						<span class="h3">Add Resource</span>
					...
					<div class="card-body">
						<form class="" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="radio" name="syllabus">male
