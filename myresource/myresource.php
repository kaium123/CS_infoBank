<?php
	...
	$syllabus=$blog->viewmysyllabus($id);
	$booklist=$blog->viewmybooklist($id);
	$notes=$blog->viewmynotes($id);
	$tips=$blog->viewmytips($id);
						...
						<div class="card-body">
							...
							<?php while($blogs=mysqli_fetch_assoc($syllabus)) { ?>
								<tr>
									...
									<td>
										<a href="edit-blog.php" class="btn btn-info btn-sm">Edit</a>
